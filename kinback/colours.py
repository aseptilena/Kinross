...
# The colour string may be # + 3/6/8 hexes, an alias or an RGB bracket. The opacity is a string representing a number in [0, 1].
...
def col2repr(col, alpha = None):
    ...
    elif "(" in col: # RGB bracket. A waste of space, but still generated by Illustrator.
