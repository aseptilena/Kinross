...
out = open("coords.svg", 'w')
out.write('<svg><rect fill="#230f38" width="8" height="8"/><path style="fill:none;stroke:#6dc6fb;stroke-width:.25;stroke-linecap:round;stroke-linejoin:round" d="M1 1 {0} 7 7"/><svg>'.format(" ".join(c)))
out.close()
