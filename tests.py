...
# {(4.7995147433659895, 51.14533946694863), 100.0, 50.0, 0.17453292519943295: 4.575886525335371 -> -0.36097503655678714}
print(elliparc(0, 100, 50, 10, 1, 0, 100+50j))
print(elliparc(1, ellipse(1+2j, 2, 1, 0.3), 2)) # {(1.0, 2.0), 2.0, 1.0, 0.3: 1.0 -> 2.0}
