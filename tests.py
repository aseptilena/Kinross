...
print(minmitrelimit([[bezier(1, 2, 3, 4)]])) # 4

b = bezier(5j, 9+2j, 3+1j, 12+7j)
for i in b.inflections(): print(b(i)) # (7.341640786499875+3.5236067977499794j) and (4.658359213500126+3.076393202250021j)
print(b.length()) # 13.928561431506896
